...
from .forms import PostSearchForm, CommentCreationForm, CommentReplyForm, PostCreateUpdateForm
...
class PostUpdateView(LoginRequiredMixin, View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        return render(request, 'home/detail.html', {'form':form,'post':post})
...
class PostAddReplyView(LoginRequiredMixin, View):
    ...
    def post(self, request, post_id, comment_id):
        ...
        if form.is_valid():
            ...
            reply.is_reply = True
            reply.save()
            messages.success(request, 'your reply submittedsuccessfully', 'success')
        return redirect('home:post_detail', post.id, post.slug)
